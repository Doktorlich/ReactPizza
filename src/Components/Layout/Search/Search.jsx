...
const Search = () => {
    ...
    const changeValeuSearchHandler = function (event) {
    ...
    return (
        <div className={styled["search-block"]}>
            ...
            <input placeholder="Search pizza" className={styled.input} onChange={changeValeuSearchHandler} value={valueSearch} />
            {valueSearch && (
                <svg
                    height="48"
                    viewBox="0 0 48 48"
